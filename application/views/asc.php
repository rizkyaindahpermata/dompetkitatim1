        ...
        <li data-target="#carousel-example-generic" data-slide-to="4"></li>
           ...
           <!-- Wrapper for slides -->
              <div class="carousel-inner">
				 ...
				 <img src="<?php echo base_url('assets/front/images/slider/hati2.jpg') ?>" alt="0"> 
						     </div>							
							<div class="item">
								<img src="<?php echo base_url('assets/front/images/slider/5.jpg') ?>" alt="1">
							</div>
							<div class="item">
								<img src="<?php echo base_url('assets/front/images/slider/foto1.PNG') ?>" alt="2">							
							</div>
            </div>
          </div>
        </div>
	...
	<div class="row" id="city">
		<div class="section">
			<div class="col-md-12 text-center">
				<h5 class="font-purple font-bold font-xl">DOMPET KITA</h5>
				<p class="font-medium font-md">Mari Saling Membantu Untuk Kemanusiaan</p>
				<br><br>
